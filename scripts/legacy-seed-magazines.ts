...
흡연은 임플란트 실패의 최대 원인 중 하나입니다. 최소 보철 완성 후 6개월까지 금연 권장. 술도 식립 후 2주는 금주 권장.`,
  ...
  // ─────────────────────────────────────────────
  // [05] 지역 가이드 — 강남 임플란트 가격·인증
  // ─────────────────────────────────────────────
  {
    slug: "gangnam-implant-top10-2026",
    type: "regional",
    seoTitle: "강남 임플란트 가격·인증 가이드 (2026) — 메디록 인증 의원",
    metaDescription:
      "2026년 6월 기준 메디록 4단계 인증을 통과한 강남구 임플란트 치과의 가격·시설·의료진 정보를 정리했습니다. 가격대·평점·시술 건수 비교.",
    shortAnswer:
      "강남구에서 메디록 4단계 인증 + 큐레이션 심사를 통과한 임플란트 치과는 18곳입니다. 단일 임플란트 평균 가격대는 120~180만원이며, 의원별 임상 경험·시설·전문의 구성에 따라 차이가 있습니다. 인증 의원의 가격·후기·시술 정보를 비교해 선택하세요. (메디록, 2026.06)",
    body: `## 메디록 인증 기준

메디록 4단계 인증(진료이력·실방문 후기·의료진 자격·시설장비)을 통과한 의원을 기준으로 합니다. 비교 시 함께 보면 좋은 항목:
- 임상 경험 (시술 건수, 운영 연수)
- 환자 만족도 (★ 4.5 이상)
- 시설·장비 (3D CT, 위생 1등급)
- 의료진 전문성 (전문의 비율)
...
강남구 메디록 인증 치과의 단일 임플란트 가격은 평균 120~180만원입니다. 국산·수입 브랜드, 보철 재료, 3D 디지털 가이드 적용 여부에 따라 차이가 발생합니다. 의원별 정상가·이벤트가는 각 의원 카드에서 확인하세요.`,
    targetKeywords: [
      "강남 임플란트 가격",
      "강남구 임플란트 치과",
      "강남 임플란트 의원",
    ...
    faqBlocks: [
      {
        question: "메디록 인증 의원은 어떤 기준으로 검증되나요?",
        answer:
          "메디록 4단계 인증(진료이력·실방문 후기·의료진 자격·시설장비)을 통과한 의원을 임상 경험·환자 만족도·전문성 기준으로 검증합니다.",
      },
    ],
    linkedHospitalSlugs: ["hangyeol-dental", "myungheon-dental", "songhak-dental"],
    linkedDepartmentSlug: "dental",
