...
export const seedMagazines: Magazine[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaDescription:
      "2026년 6월 기준 강남구 메디록 인증 18개 치과의 임플란트 가격을 정리했습니다. 정상가·이벤트가·시니어 보험 적용가까지 비교.",
    shortAnswer:
      "2026년 6월 기준 강남구 메디록 인증 18개 치과 임플란트 단일 평균 120~180만원, 이벤트가는 35~49만원부터입니다. 65세 이상 평생 2개까지 건강보험 적용 시 본인부담 50% (약 60~90만원). (메디록, 2026.06)",
...
메디록 4단계 인증을 통과한 강남구 18개 치과의 평균 가격:`,
    targetKeywords: [
      "강남 임플란트 가격",
      "강남구 임플란트",
      "임플란트 가격 2026",
    ...
    faqBlocks: [
      {
        ...
        answer:
          "2026년 6월 메디록 인증 18개 치과 기준 임플란트 단일 평균 120~180만원입니다. 이벤트가는 35~49만원부터, 65세 이상 보험 적용가는 약 60~90만원 (본인부담 50%) 입니다.",
      },
      {
        question: "왜 같은 임플란트인데 가격이 다른가요?",
        answer:
          "임플란트 브랜드(국산 vs 수입), 보철 재료(지르코니아 등), 3D CT 정밀도, 의원 규모에 따라 25만~200만원까지 차이가 납니다. 단순 비교보다 메디록 4단계 인증 + 평생 보장 여부를 함께 확인하세요.",
      },
      {
  ...
  // ─────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "65세 이상은 잔존 골량·전신 건강·예산을 종합 판단합니다. 잔존 치아 4~6개 이상 + 당뇨 등 만성질환 잘 관리되면 임플란트 우선, 골 흡수 심하면 임플란트 틀니 권장. 평균 결정 시간 2~4주, 메디록 인증 의원의 3D CT 무료 진단 활용 권장. (메디록, 2026.06)",
...
## 의사결정 흐름`,
    ...
    faqBlocks: [
      {
        ...
        answer:
          "가능합니다. 나이보다 골밀도, 당뇨·고혈압 관리 상태가 중요합니다. 메디록 인증 의원에서 3D CT 진단으로 가능 여부를 확인하세요.",
      },
      {
  ...
  // ─────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "만 65세 이상은 평생 2개까지 건강보험 적용 가능하며 본인부담 50% (약 60~90만원/개)입니다. 어금니·앞니 모두 가능하나 의원이 보험 청구 시스템을 갖춰야 합니다. 메디록 인증 의원은 보험 적용가를 명시합니다.",
...
메디록 인증 의원 중 "보험 적용" 표시가 있는 의원을 확인하세요. 메디록은 의원의 보험 청구 시스템 보유 여부를 4단계 인증에서 검증합니다.`,
    targetKeywords: [
      "65세 임플란트 보험",
      "임플란트 건강보험",
      "노인 임플란트 보험 적용",
...
흡연은 임플란트 실패의 최대 원인 중 하나입니다. 최소 보철 완성 후 6개월까지 금연 권장. 술도 식립 후 2주는 금주 권장.`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    type: "regional",
    seoTitle: "강남 임플란트 의원 추천 TOP 10 (2026) — 메디록 인증",
    metaDescription:
      "2026년 6월 메디록 메디록 4단계 인증을 통과한 강남구 임플란트 치과 TOP 10. 가격·평점·시술 건수 비교.",
    shortAnswer:
      "강남구에서 메디록 4단계 인증 + 큐레이션 심사를 통과한 임플란트 치과 18곳 중 TOP 10을 선정했습니다. 1위는 강남 한결치과의원(역삼동, 12년차, 임플란트 5,200건, ★4.9). 평균 가격대 120~180만원. (메디록, 2026.06)",
    body: `## 선정 기준

메디록 4단계 인증 통과 + 다음 가중치:
- 임상 경험 (시술 건수, 운영 연수)
- 환자 만족도 (★ 4.5 이상)
- 시설·장비 (3D CT, 위생 1등급)
- 의료진 전문성 (전문의 비율)
...
## TOP 10`,
    ...
    faqBlocks: [
      {
        question: "이 랭킹은 어떤 기준으로 선정되나요?",
        answer:
          "메디록 4단계 인증(진료이력·실방문 후기·의료진 자격·시설장비)을 통과한 의원 중 큐레이터가 임상 경험·환자 만족도·전문성을 종합 평가해 선정합니다.",
      },
    ],
    linkedHospitalSlugs: ["hangyeol-dental", "myungheon-dental", "songhak-dental"],
    linkedDepartmentSlug: "dental",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaDescription:
      "강남구와 서초구 메디록 인증 치과 가격대 비교. 임플란트·보철·교정 평균 가격과 의원 선택 팁.",
    shortAnswer:
      "메디록 인증 의원 기준 강남구는 임플란트 평균 120~180만원, 서초구는 110~160만원으로 서초가 약 5~10% 저렴합니다. 다만 강남은 시술 건수·전문의 비율이 높아 케이스 난이도 큰 환자는 강남이 적합. (메디록, 2026.06)",
    body: `## 두 지역의 차이
...
\"제 인터뷰가 아닌 객관 데이터로 답드리겠습니다. 12년 운영, 5,200건 시술, 환자 ★4.9 평점, 0건의 의료사고. 메디록 4단계 검증 + 큐레이터 추가 심사를 통과했습니다.\"`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "신사 송학치과는 15년 동안 시니어 임플란트만 3,500건을 시술해온 특화 의원입니다. 의원 평균 가격 100~150만원으로 강남권에서 합리적이며, 메디록 4단계 인증을 받았습니다.",
    body: `## 송학치과의 차별점
...
- 골 이식 + 임플란트 — 케이스별 상담`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "67세 여성 환자의 풀마우스 임플란트(상악 전체) 케이스. 총 시술기간 6개월, 총 비용 2,400만원, 메디록 인증 강남 한결치과 한진우 원장 시술. 환자 본인 및 보호자 게재 동의서를 받았습니다.",
    body: `## 환자 정보 (익명)
